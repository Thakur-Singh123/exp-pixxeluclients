...
.nav-bar ul{list-style:none;margin:0;padding:0;display:flex;justify-content:center;align-items: center;gap: 14px;}
...
.news-scroll{height: 630px;;overflow:hidden}
...
.dis-message p {line-height: 25px;font-size: 16px;font-family: sans-serif;padding: 0 25px;text-align: center;}
span.cosa-msg {color: #f19000;font-size: 24px;}
.hero-sec-image img {height: 536px;object-fit: cover;}
.hero-slider img {width: 100%;height: 686px;}
.hero-slider {width: 35%;}
