            ...
            <div class="card shadow-sm p-4">
               ...
               <div class="step-content d-none" id="step-1">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4 mb-3"><strong>Expose Year:</strong> {{ $veerNari_detail->veer_nari_expose_year ?? '-' }}</div>
                  </div>
               ...
               <div class="step-content" id="step-2">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4 mb-3 services1"><strong>PPO Number:</strong> {{ $veerNari_detail->serviceman_detail->ppo_no ?? '-' }}</div>
                     <div class="col-md-4 mb-3 services1"><strong>Regiment / Corps:</strong> {{ $veerNari_detail->serviceman_detail->regiment_corps ?? '-' }}</div>
                     <div class="col-md-4 mb-3 services1"><strong>Force Type:</strong>{{ $veerNari_detail->serviceman_detail->force_type ?? '-' }}</div>
                     <div class="col-md-4 mb-3 services1"><strong>Date of Birth:</strong>{{ $veerNari_detail->serviceman_detail->dob ? \Carbon\Carbon::parse($veerNari_detail->serviceman_detail->dob)->format('d M, Y') : '-' }}</div>
                     <div class="col-md-4 mb-3 services1"><strong>Date of Enrollment:</strong>{{ $veerNari_detail->serviceman_detail->doe ? \Carbon\Carbon::parse($veerNari_detail->serviceman_detail->doe)->format('d M, Y') : '-' }}</div>
                     <div class="col-md-4 mb-3 services1"><strong>Date of Retirement:</strong>{{ $veerNari_detail->serviceman_detail->dor ? \Carbon\Carbon::parse($veerNari_detail->serviceman_detail->dor)->format('d M, Y') : '-' }}</div>
                     ...
                     <div class="col-md-4 mb-3 services1"><strong>MICR Code:</strong> {{ $veerNari_detail->serviceman_detail->micr_code ?? '-' }}</div>
                      <div class="col-md-4 mb-3 services1"><strong>Canteen Card Number:</strong>{{ $veerNari_detail->serviceman_detail->canteen_card ?? '-' }}</div>
                  </div>
                  <!-- Images -->
                  <div class="mt-4 services001">
