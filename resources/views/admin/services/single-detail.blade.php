         ...
         <div class="col-md-12">
            <div class="card shadow-sm p-4">
               ...
               <div class="step-content" id="step-1">
                  ...
                  <div class="row">
                     <div class="col-md-4 mb-3"><strong>Sr. No:</strong> {{ $service_detail->sr_no ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Army No:</strong> {{ $service_detail->army_no ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Rank:</strong> {{ $service_detail->rank ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Name:</strong> {{ $service_detail->name ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Village:</strong> {{ $service_detail->village ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Post Office:</strong> {{ $service_detail->post_office ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Tehsil:</strong> {{ $service_detail->tehsil ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>District:</strong> {{ $service_detail->district ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>State:</strong> {{ $service_detail->state ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Pin Code:</strong> {{ $service_detail->pin_code ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Mobile No:</strong> {{ $service_detail->mobile_no ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Education:</strong> {{ $service_detail->education ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Present Occupation:</strong> {{ $service_detail->present_occupation ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Aadhar No:</strong> {{ $service_detail->aadhar_card_no ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>PAN No:</strong> {{ $service_detail->pan_card_no ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>ECHS No:</strong> {{ $service_detail->echs_card_no ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>CSD No:</strong> {{ $service_detail->csd_card_no ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Regiment / Corps:</strong> {{ $service_detail->regiment_corps ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>DOB:</strong> {{ \Carbon\Carbon::parse($service_detail->dob)->format('d M, Y') ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>DOE:</strong> {{ \Carbon\Carbon::parse($service_detail->doe)->format('d M, Y') ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>DOR:</strong> {{ \Carbon\Carbon::parse($service_detail->dor)->format('d M, Y') ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Bank Account No:</strong> {{ $service_detail->bank_acc_no ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Bank Name:</strong> {{ $service_detail->bank_name ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>IFSC Code:</strong> {{ $service_detail->ifsc_code ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>MICR Code:</strong> {{ $service_detail->micr_code ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Decorator Soldier:</strong> {{ $service_detail->decorator_soldier ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>Disabled:</strong> {{ $service_detail->disabled ?? '-' }}</div>
                     <div class="col-md-4 mb-3"><strong>DGR Portal:</strong> {{ $service_detail->reg_on_dgr_portal ?? '-' }}</div>
                  </div>
                  <!-- Images -->
                  <div class="row mt-4">
                     <div class="col-md-4">
                        ...
                        @if($service_detail->image)
                           <img src="{{ asset('public/uploads/ex-images/'.$service_detail->image) }}" class="img-thumbnail shadow-sm" width="80">
                        @else 
                           - 
                        @endif
                     </div>
